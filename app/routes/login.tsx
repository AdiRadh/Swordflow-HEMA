    ...
    <div className="flex min-h-full flex-col justify-center">
      <div className="mx-auto w-full max-w-md px-8">
        <Form method="post" className="space-y-6" noValidate>
          ...
          <button
            className="w-full rounded bg-amber  py-2 px-4 text-white hover:bg-amber focus:bg-amber"
            type="submit"
          >
            Log in
          </button>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                className="h-4 w-4 rounded border-amber text-amber focus:amber"
                id="remember"
                name="remember"
                type="checkbox"
              />
              <label
                className="ml-2 block text-sm text-amber"
                htmlFor="remember"
              >
                Remember me
              </label>
